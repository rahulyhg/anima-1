<section class="panel">
    ...
    <div class="panel-body">
        <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editphotographeralbumsubmit");?>' enctype='multipart/form-data'>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" id="normal-field" class="form-control" name="tab" value='<?php echo set_value(' tab ',$before->tab);?>'>
                </div>
            </div>
            <div class=" form-group">
