...
<body>
  ...
  <?php include('header.php'); ?>
        ...
        <div class="container">
            <div class="bio_inner">
                <img src="images/model/5.jpg" style="width: 90%; float: right; ">
                <img src="images/model/11.jpg" style="width: 90%; float: right; ">
                <img src="images/model/5.jpg" style="width: 90%; float: right; ">
                <img src="images/model/11.jpg" style="width: 90%; float: right; margin-bottom: 40px; ">
            </div>
            <div class="bio_inner">
                <p>16.01.2015</p>
